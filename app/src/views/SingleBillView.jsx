...
class SingleBillView extends Component {
    render() {
        ...
        return (<div>
            ...
            <div className={styles.sponsor}>Sponsor: <Link to={`${process.env.PUBLIC_URL}/lawmaker/${getLawmakerUrlName(sponsor)}`}>{sponsor.name}</Link>, {sponsor.party}-{sponsor.city}</div>
